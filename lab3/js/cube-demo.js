...
var drawBufferFace = function ( gl, rotation, move, projection, buffer, textureId, textureUnit ) {
    ...
    */
    ...
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, min_filters[filter]);
...
function onKeyDown(e){
    ...
    case "Space":
    case "h":
        filter = (filter + 1) % min_filters.length;
        break;
    case "y":
        mag_filter = ((mag_filter == gl.LINEAR) ? gl.NEAREST : gl.LINEAR);
        break;
	/*
	  case 77: // M
	  case 82: // R
...
window.onload = function(){
    ...
    const bruh = () => {
        ...
        image.onload = () => {
            canvasTex.getContext("2d").drawImage(image, 0, 0, 512, 512);
